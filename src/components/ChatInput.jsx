    ...
    py-4 overflow-auto relative">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* textarea as controll input */}
          <textarea
            onKeyDown={(e) => {
              e.keyCode === 13 && e.shiftKey === false && handleSubmit();
            }}
            // this will check each key stroke .... shift+enter=new line
            rows={1}
          ...
          />
         {/* if i write anything inside textarea it is going to store in value which is our state */}
          <img
